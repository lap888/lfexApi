...
namespace domain.enums
{
    ...
    public enum AccountModifyType
    {
        ...
        /// 扣除赏金
        /// </summary>
        [Description("扣除赏金 任务编号:{0}")]
        DEDUCTION_BOUNTY = 3,
        /// <summary>
        /// 任务赏金
        /// </summary>
        [Description("任务赏金 任务编号:{0}")]
        MIAAION_BOUNTY = 4,
        /// <summary>
        /// 现金分红
        /// </summary>
        [Description("现金分红 糖果:{0}颗,每糖果{1}元")]
        CASH_DEVIDEND = 5,
        /// <summary>
        /// 系统收单
        /// </summary>
        [Description("糖果交易 单号:{0}")]
        SYSTEM_ACQUIRE = 6,
        /// <summary>
        /// 现金分红体验券
        /// </summary>
        [Description("现金分红体验券 糖果:{0}颗,每糖果{1}元")]
